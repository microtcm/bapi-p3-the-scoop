...
function createComment(url, request) {
  ...
  const response = {};
// check if valid request content & valid database user
...
//Bonus: Save and Read YAML filter
...
function loadDatabase(){
  ...
  read('database.yml', function(err, data) {
    if (err) return console.log('Load database error: '+err);
    database = data;
  });
